...
class EEG_MainHelper:
    ...
    @staticmethod
    def main_with_psi1(list_freq_by_response, list_freq_by_stimulus, list_freq_by_visibility, som,
                       eegDataProcessorTrials,
    ...
    @staticmethod
    def main_with_psi2(list_freq_by_response, list_freq_by_stimulus, list_freq_by_visibility, som,
                       eegDataProcessorTrials,
    ...
    def full_pipeline(eegDataProcessor, som, pathLeft, pathRight, pathWindowStart, pathWindowEnd, params, coeff,
        ...
        list_freq_by_response = PlotsGenerator.groupByResponseV2(window_start_trials, som, pathWindowStart, params,
                                                                 alignment=Alignment.LEFT, method=Method.BMU)
        list_freq_by_stimulus = PlotsGenerator.groupByStimulusV2(window_start_trials, som, pathWindowStart, params,
                                                                 alignment=Alignment.LEFT, method=Method.BMU)

...
class BinaryFileReader:
    ...
    def read_timestamps(self, timestamp_filename):
        return self.read_data_file(timestamp_filename, 'i')

    def read_waveforms(self, waveform_filename):
        return self.read_data_file(waveform_filename, 'f')

    def read_unit_statistics(self, unit_statistics_filename):
        return self.read_data_file(unit_statistics_filename, 'f')
